...
- Towards Expert-level Autonomous Carotid Ultrasonography with Large-scale Learning-based Robotic System (Keywords: Embodied Medical Robot) (_Nature Communications'25_) [Paper][[Code](https://github.com/LeapLabTHU/UltraBot)]
...
### 💬 News
**[2025/06]**: Carotid UltraBot is accepted by Nature Communications (IF=14.7)! This is [LeapLab](https://www.leaplab.ai/)'s first Nature sub-journal paper. Thanks to all the collaborators.  
